  ...
  return (
    <div className="container mx-auto pt-16">
        <div className="xl:py-16 lg:py-16 md:py-16 sm:py-16 px-15 flex flex-wrap">
            {logos.map((url, id) => (
                <div key={id} className="w-6/12 xl:w-1/4 lg:w-1/4 md:w-1/4 flex justify-center xl:border-l lg:border-l border-gray-200 xl:pt-10 lg:pt-10 md:pt-2 pt-16">
                    <img className="focus:outline-none" src={url.url} alt={url} />
                </div>)
            )}
        </div>
    </div>
