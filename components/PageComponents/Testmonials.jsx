...
const testimonialsCards = testimonyData.map(({id,img,message,name,title})=>{
    return (
    <Carousel.Slide>
        <div  key={id} className="lg:w-full lg:mb-0 mb-6 p-4 w-full">
            <div className="h-full text-center">
                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src={img}/>
